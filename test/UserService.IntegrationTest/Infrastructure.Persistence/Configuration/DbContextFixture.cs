...
namespace UserService.IntegrationTest.Infrastructure.Persistence.Configuration
{
    public class DbContextFixture : IAsyncLifetime
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            appDbContextOptionsBuilder.UseSqlServer(connectionString,
                       ...
                       {
                           sqlOptions.MigrationsAssembly(typeof(UserService.Infrastructure.Persistence.ApplicationDbContext).GetTypeInfo().Assembly.GetName().Name);
                       });
